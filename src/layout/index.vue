  ...
  <div class="content">
    <div class="left-content">
      ...
      >
        ...
        <el-submenu index="1">
          <template slot="title">
            <i><img src="../assets/header-icon/nav-icon-multiple.svg" alt="" /></i>
            <span>链属企业管理</span>
          </template>
          <el-menu-item-group>
            <el-menu-item index="/p1-company-management-list">
              <span>链属企业列表</span>
            </el-menu-item>
            <el-menu-item index="/p2-company-management-approval">
              <span>减排计划申报</span>
            </el-menu-item>
          </el-menu-item-group>
        </el-submenu>
        ...
        <el-submenu index="2">
          ...
          <el-menu-item-group>
            <el-menu-item index="/p3-kong-account-detail"
              >账户信息</el-menu-item
            >
            <el-menu-item index="/p4-carbon-credit-created"
              >碳信创建</el-menu-item
            >
            <el-menu-item index="/p5-carbon-credit-destroyed"
              >碳信销毁</el-menu-item
            >
          </el-menu-item-group>
        </el-submenu>
        <el-submenu index="3">
          <template slot="title">
              <i><img src="../assets/header-icon/nav-icon-management-board.svg" alt="" /></i>
            <span>碳信管理</span>
          </template>
          <el-menu-item-group>
            <el-menu-item index="/p6-company-carbon-credit-account-detail"
              >企业碳信账户</el-menu-item
            >
            <el-menu-item index="/p7-carbon-credit-launching"
              >碳信发行</el-menu-item
            >
            <el-menu-item index="/p8-carbon-credit-repo-list"
              >碳信回购</el-menu-item
            >
          </el-menu-item-group>
        </el-submenu>
        <el-menu-item index="/p9-pledge-application">
          <i><img src="../assets/header-icon/nav-icon-application.svg" alt="" /></i>
          <span>碳配额质押申请</span>
        </el-menu-item>
        <el-menu-item index="/p10-notifications-list">
           <i><img src="../assets/header-icon/nav-icon-message-list.svg" alt="" /></i>
          <span>信息通知</span>
        </el-menu-item>
      </el-menu>
    </div>
    <div class="right-content">
      ...
      >
        ...
        <span slot="footer" class="dialog-footer">
          ...
          <el-button type="primary" @click="submitLoginForm(ruleForm)">确 定</el-button>
        </span>
      </el-dialog>
