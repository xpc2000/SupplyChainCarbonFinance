  ...
  <div class="content">
    <div class="left-content">
      ...
      <el-menu
        ...
        :router="true"
      >
        <div class="nav-small-label">控排链链属企业</div>
        ...
        <el-submenu index="3">
          ...
          <el-menu-item-group>
            <el-menu-item index="/kongpaiChainEnterprise/p6-company-carbon-credit-account-detail"
              >企业碳信账户</el-menu-item
            >
            <el-menu-item index="/kongpaiChainEnterprise/p7-carbon-credit-launching"
              >碳信发行</el-menu-item
            >
            <el-menu-item index="/kongpaiChainEnterprise/p8-carbon-credit-repo-list"
              >碳信回购</el-menu-item
            >
          </el-menu-item-group>
        </el-submenu>
        <el-menu-item index="/kongpaiChainEnterprise/p9-pledge-application">
          <i><img src="../assets/header-icon/nav-icon-application.svg" alt="" /></i>
          <span>碳配额质押申请</span>
        </el-menu-item>
        <el-menu-item index="/kongpaiChainEnterprise/p10-notifications-list">
