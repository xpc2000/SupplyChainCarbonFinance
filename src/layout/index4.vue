  ...
  <div class="content">
    <div class="left-content">
      ...
      <el-menu
        ...
        :router="true"
      >
        <div class="nav-small-label">减排链链属企业</div>
        ...
        <el-submenu index="3">
          ...
          <el-menu-item-group>
            <el-menu-item
              index="/jianpaiLinkedEnterprise/p2-company-carbon-credit-account-detail"
              >企业碳信账户</el-menu-item
            >
            <el-menu-item
              index="/jianpaiLinkedEnterprise/p3-carbon-credit-transfer"
              >碳信转让</el-menu-item
            >
          </el-menu-item-group>
        </el-submenu>
        ...
        <el-submenu index="4">
          ...
          <el-menu-item-group>
            <el-menu-item
              index="/jianpaiLinkedEnterprise/p4-financing-application"
              >融资申请</el-menu-item
            >
          </el-menu-item-group>
        </el-submenu>
        ...
        <el-submenu index="5">
          ...
          <el-menu-item-group>
            <el-menu-item
              index="/jianpaiLinkedEnterprise/p5-carbon-receiving-task"
              >签收碳信</el-menu-item
            >
          </el-menu-item-group>
        </el-submenu>

        <el-menu-item index="/jianpaiLinkedEnterprise/p6-notifications-list">
          <i
